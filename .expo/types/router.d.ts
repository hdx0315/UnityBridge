...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(auth)` | `/(tabs)` | `/CallDetails` | `/InboxChat` | `/OthersProfile` | `/_sitemap` | `/appSettings` | `/calls` | `/chats` | `/pages` | `/profile` | `/profileSettings` | `/search` | `/settings` | `/sign-in` | `/sign-up`;
